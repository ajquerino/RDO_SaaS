...
export type Servico = { obraItemId?: string | null; atividade?: string; local?: string; qtdExec?: number | null; unidade?: string; status?: string; pctInformado?: number | null; motivoHold?: string; obs?: string; pctItem?: number; avancoAnterior?: number | null };
